...
body.style.background = "linear-gradient(60deg, "+rgb(50, 25, 75)+", green, blue)";
...
function algorithm_withGradient() {

	switch(turn){
		case(0):
			if (red >= 0 & red != 255) {
				red = red + 1;
				body.style.background = "linear-gradient(60deg, "+red+", "+green+", "+blue+")";
		...
		case(1):
			if (green >= 0 & green != 255) {
				green = green + 1;
				body.style.background = "linear-gradient(60deg, "+red+", "+green+" 50%, "+blue+")";
...
function paintFadeDegrade(time) {
	setInterval("algorithm_withGradient()", time);
}